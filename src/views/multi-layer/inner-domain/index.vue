            ...
            <el-table :data="dspNodeShows">
              ...
              >
                <template slot-scope="scope">
                  ...
                  <!--<span style="margin-left: 10px">{{ scope.row.services.map(x=>id2service(x).serviceName) }}</span>-->
                </template>
              </el-table-column>
        ...
        <el-tab-pane label="领域内服务模式间关系" name="second">
          ...
          <el-row>
            ...
            >
              ...
              >
                <template slot-scope="scope">
                  <a style="margin-left: 10px" @click="alert('后续弹出一个图，说明为什么存在这个关系')">{{ scope.row.relationship }}</a>
                </template>
              </el-table-column>
            </el-table>
          </el-row>
...
import DPRelation from './domain-provider-relation2'

export default {
  components: {
    // Pagination
    ServiceTable,
    // domainSvg, providerSvg,
    DPRelation
  },
  data() {
    return {
      ...
      tableKey: 0,
      list: null,
      dspGraph: { 'nodes': [{ 'id': 'dsp1', 'bpmn': '一个图片的url', 'services': [57, 58, 61, 99, 101, 134], 'inner_services': [], 'inner_ssps': ['ssp1', 'ssp2'], 'freq': 3, 'domain': '医疗服务' }, { 'id': 'dsp2', 'bpmn': '一个图片的url', 'services': [57, 58, 61, 137, 100], 'inner_services': [137, 100], 'inner_ssps': ['ssp1'], 'freq': 5, 'domain': '医疗服务' }, { 'id': 'dsp3', 'bpmn': '一个图片的url', 'services': [57, 58, 61, 97, 100, 138], 'inner_services': [], 'inner_ssps': ['ssp1', 'ssp3'], 'freq': 6, 'domain': '医疗服务' }, { 'id': 'dsp4', 'bpmn': '一个图片的url', 'services': [1, 7, 8], 'inner_services': [], 'inner_ssps': ['ssp4'], 'freq': 5, 'domain': '养老服务' }, { 'id': 'dsp5', 'bpmn': '一个图片的url', 'services': [14, 17, 18, 16], 'inner_services': [], 'inner_ssps': ['ssp5'], 'freq': 5, 'domain': '养老服务' }, { 'id': 'dsp6', 'bpmn': '一个图片的url', 'services': [140, 141, 142, 143], 'inner_services': [], 'inner_ssps': ['ssp6'], 'freq': 3, 'domain': '养老服务' }, { 'id': 'dsp7', 'bpmn': '一个图片的url', 'services': [102, 103, 104, 105, 106, 100, 146], 'inner_services': [146], 'inner_ssps': ['ssp7'], 'freq': 5, 'domain': '医疗服务' }, { 'id': 'dsp8', 'bpmn': '一个图片的url', 'services': [112, 113, 114, 115, 108], 'inner_services': [], 'inner_ssps': ['ssp8'], 'freq': 5, 'domain': '医疗服务' }, { 'id': 'dsp9', 'bpmn': '一个图片的url', 'services': [146, 100], 'inner_services': [146, 100], 'inner_ssps': [], 'freq': 4, 'domain': '医疗服务' }], 'edges': [{ 'source': 'dsp3', 'target': 'dsp1', 'relationship': '连接关系', 'type': 'one-way' }, { 'source': 'dsp7', 'target': 'dsp9', 'relationship': '整体局部', 'type': 'one-way' }, { 'source': 'dsp1', 'target': 'dsp4', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp1', 'target': 'dsp5', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp1', 'target': 'dsp6', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp1', 'target': 'dsp7', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp1', 'target': 'dsp8', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp1', 'target': 'dsp9', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp2', 'target': 'dsp4', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp2', 'target': 'dsp5', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp2', 'target': 'dsp6', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp2', 'target': 'dsp8', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp3', 'target': 'dsp4', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp3', 'target': 'dsp5', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp3', 'target': 'dsp6', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp3', 'target': 'dsp8', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp4', 'target': 'dsp5', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp4', 'target': 'dsp6', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp4', 'target': 'dsp7', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp4', 'target': 'dsp8', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp4', 'target': 'dsp9', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp5', 'target': 'dsp6', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp5', 'target': 'dsp7', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp5', 'target': 'dsp8', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp5', 'target': 'dsp9', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp6', 'target': 'dsp7', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp6', 'target': 'dsp8', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp6', 'target': 'dsp9', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp7', 'target': 'dsp8', 'relationship': '功能互补', 'type': 'two-way' }, { 'source': 'dsp8', 'target': 'dsp9', 'relationship': '功能互补', 'type': 'two-way' }] },
      ...
      dspGraph2: { 'nodes': [{ 'id': 'dsp1', 'bpmn': '一个图片的url', 'services': [57, 58, 61, 99, 101, 134], 'inner_services': [], 'inner_ssps': ['ssp1', 'ssp2'] }, { 'id': 'dsp2', 'bpmn': '一个图片的url', 'services': [57, 58, 61, 137, 100], 'inner_services': [137, 100], 'inner_ssps': ['ssp1'] }, { 'id': 'dsp3', 'bpmn': '一个图片的url', 'services': [57, 58, 61, 97, 100, 138], 'inner_services': [], 'inner_ssps': ['ssp1', 'ssp3'] }], 'edges': [{ 'source': 'dsp3', 'target': 'dsp1', 'relationship': '连接关系', 'type': 'one-way' }] },
      sspGraph21: { 'nodes': [{ 'id': 'ssp1', 'services': [57, 58, 61], 'provider': '天鑫' }], 'edges': [] },
      sspGraph22: { 'nodes': [{ 'id': 'ssp2', 'services': [99, 101, 134], 'provider': '众阳软件' }, { 'id': 'ssp3', 'services': [97, 100, 138], 'provider': '众阳软件' }], 'edges': [{ 'source': 'ssp2', 'target': 'ssp3', 'relationship': '功能互补', 'type': 'two-way' }] },
      // ssp: [],
      // sspShowed: [],
      // dspR: [],
      // dspRShowed: [],
  ...
  computed: {
    dspNodeShows: function() {
      const nodes = this.dspGraph.nodes.filter(nd => nd.domain == this.listQuery.domain)
  ...
  methods: {
    ...
    handleSearch() {
      ...
      this.$refs['dp-graph'].processDataOld()
      setTimeout(() => {
        this.$refs['dp-graph'].drawLink()
      }, '3000')
