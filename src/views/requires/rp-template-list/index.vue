        ...
        <el-card class="box-card">
          <el-form ref="form" label-width="80px">
            ...
            <el-form-item label="所属领域">
              <el-tree-select ref="treeSelect" v-model="info.categories" :styles="styles" :select-params="selectParams" :tree-params="treeParams" :tree-render-fun="_renderFun" @searchFun="_searchFun" @node-click="_nodeClickFun" />
            </el-form-item>
          </el-form>
        </el-card>
        <br>
...
import '../rp-template-add/category.scss'
import Vue from 'vue'
import Axios from 'axios'
import ElTreeSelect from 'el-tree-select'
import SPTP from '../rp-template-add/spt-property'
