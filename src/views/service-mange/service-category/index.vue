...
export default {
  ...
  methods: {
    loadData() {
      this.$ajax.get('/serviceCategory/listRoots').then(res => {
    ...
    onAdd() {
      this.$refs['addForm'].validate((valid) => {
        if (valid) {
          this.$ajax.post('/serviceCategory/create', this.addForm)
    ...
    onUpdate() {
      this.$refs['updateForm'].validate((valid) => {
        if (valid) {
          this.$ajax.post(`/serviceCategory/update/${this.updateForm.catelogyId}`, this.updateForm)
            .then(response => response.data)
            .then((data) => {
              this.loadData()
              this.handleChange(data, true)
